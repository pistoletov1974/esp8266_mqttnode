...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "bar" //change this to whatever you want to call your device
#define OTApassword "bar" //the password you will need to enter to upload remotely via the ArduinoIDE
int OTAport = 8266;



/************* MQTT TOPICS (change these topics as you wish)  **************************/
const char* light_state_topic = "bar/stand";
const char* light_set_topic = "bar/stand/set";
...
float bmeTemp, bmePress, bmeHumi;
...
void sendState() {
  ...
  //Serial.print(buffer);  
  client.publish(light_state_topic,buffer2,true);
}
